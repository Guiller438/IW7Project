...
namespace IW7PP.Migrations
{
    ...
    [Migration("20240714224926_Se agregaron las tablas de donaciones")]
    partial class Seagregaronlastablasdedonaciones
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IW7PP.Models.Amputations.LowerLimbAmputation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a50d3fe4-9bb9-4b91-97ba-ee95f22153ff"),
                            AmputationName = "Below Knee"
                        },
                        new
                        {
                            Id = new Guid("6edd0aff-dc1c-4e97-a2ec-834ff4aa09da"),
                            AmputationName = "Above Knee"
                        },
                        new
                        {
                            Id = new Guid("2fa99d29-65d8-417e-afc8-11cfd493e0d8"),
                            AmputationName = "ToePartial"
                        },
                        new
                        {
                            Id = new Guid("9b73f0fb-39f6-4ddf-86d2-e726009254e9"),
                            AmputationName = "ToeComplete"
                        },
                        new
                        {
                            Id = new Guid("cebae0e0-5b7b-4790-b489-23baf61b5b97"),
                            AmputationName = "FootPartial"
                        },
                        new
                        {
                            Id = new Guid("0227edd8-eff0-434a-a9b0-daa24c4b89af"),
                            AmputationName = "Lisfranc"
                        },
                        new
                        {
                            Id = new Guid("646ce4ae-4c76-41ba-88a6-915f8faf7694"),
                            AmputationName = "Chopart"
                        },
                        new
                        {
                            Id = new Guid("1ec970b4-18b6-427a-9a34-e5ef1e38b0af"),
                            AmputationName = "AnkleDisarticulation"
                        },
                        new
                        {
                            Id = new Guid("8dd4766d-98ff-4c02-be38-b5fca0e2c2d2"),
                            AmputationName = "Transtibial"
                        },
                        new
                        {
                            Id = new Guid("13148e2f-9dac-4f71-b696-1e26dc6fc07b"),
                            AmputationName = "KneeDisarticulation"
                        },
                        new
                        {
                            Id = new Guid("d48e8d32-b0d4-4973-9cba-598e89869a92"),
                            AmputationName = "Transfemoral"
                        },
                        new
                        {
                            Id = new Guid("fd88867b-306b-4d41-b896-99e89f7a708b"),
                            AmputationName = "HipDisarticulation"
                        },
                        new
                        {
                            Id = new Guid("bd1d890a-b36a-4a5e-a42a-ffe342548650"),
            ...
            modelBuilder.Entity("IW7PP.Models.Amputations.UpperLimbAmputation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("87828a47-20ee-43e9-9726-049819082162"),
                            AmputationName = "Finger Partial"
                        },
                        new
                        {
                            Id = new Guid("460f5a70-ed33-4e8d-a2cd-6cdfa437ca51"),
                            AmputationName = "Finger Complete"
                        },
                        new
                        {
                            Id = new Guid("86d02b26-4fc1-460c-8cdf-656e7c229c4e"),
                            AmputationName = "Hand Partial"
                        },
                        new
                        {
                            Id = new Guid("c2a0de17-4362-4d04-8ab7-7dc88640cddc"),
                            AmputationName = "Wrist Disarticulation"
                        },
                        new
                        {
                            Id = new Guid("d39e8c51-89ae-456c-bbd7-7ce5e601d1a4"),
                            AmputationName = "Transradial"
                        },
                        new
                        {
                            Id = new Guid("29659335-4c25-4de7-9df8-e039b2e9e30b"),
