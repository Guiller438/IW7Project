...
namespace IW7PP.Migrations
{
    ...
    [Migration("20240715000906_Add DonationGoalToClientesProtesicos")]
    partial class AddDonationGoalToClientesProtesicos
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IW7PP.Models.Amputations.LowerLimbAmputation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c85cb6e7-e43d-420e-9a10-67d1ac868ea3"),
                            AmputationName = "Below Knee"
                        },
                        new
                        {
                            Id = new Guid("ad54c767-350f-48f8-b75e-c9bea83872f3"),
                            AmputationName = "Above Knee"
                        },
                        new
                        {
                            Id = new Guid("e139c2e3-5d4a-493f-89d9-edd6ea13a129"),
                            AmputationName = "ToePartial"
                        },
                        new
                        {
                            Id = new Guid("9d978188-dc74-4232-b83f-e650e8ec3d93"),
                            AmputationName = "ToeComplete"
                        },
                        new
                        {
                            Id = new Guid("dbebfaa1-9c64-4ace-8f4c-085c3b03bb7f"),
                            AmputationName = "FootPartial"
                        },
                        new
                        {
                            Id = new Guid("e55d16fa-7d48-45f5-af8b-dbaf7f3e1f47"),
                            AmputationName = "Lisfranc"
                        },
                        new
                        {
                            Id = new Guid("5ff42a72-b4d3-44fa-bf33-a77de0a5ddb0"),
                            AmputationName = "Chopart"
                        },
                        new
                        {
                            Id = new Guid("b7d96fff-4172-4097-9f74-a6f944d85368"),
                            AmputationName = "AnkleDisarticulation"
                        },
                        new
                        {
                            Id = new Guid("0a8ad653-a149-4f7d-96f0-34ef19e929a2"),
                            AmputationName = "Transtibial"
                        },
                        new
                        {
                            Id = new Guid("76d8c215-ca4d-413b-963c-c970dd59a0bb"),
                            AmputationName = "KneeDisarticulation"
                        },
                        new
                        {
                            Id = new Guid("2ed1f5b0-103b-4280-a658-6f8285beb9b8"),
                            AmputationName = "Transfemoral"
                        },
                        new
                        {
                            Id = new Guid("94bf0c5e-a1bf-40b9-9948-1a824b9d8305"),
                            AmputationName = "HipDisarticulation"
                        },
                        new
                        {
                            Id = new Guid("aaaa1ca1-b3cf-4db8-be6f-cb642c4f7f85"),
            ...
            modelBuilder.Entity("IW7PP.Models.Amputations.UpperLimbAmputation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("435ec171-f08f-4af5-a802-a01b662f002b"),
                            AmputationName = "Finger Partial"
                        },
                        new
                        {
                            Id = new Guid("bc623f9e-deac-41bf-84cd-1c2e25a2ab67"),
                            AmputationName = "Finger Complete"
                        },
                        new
                        {
                            Id = new Guid("366175b0-281a-4cf0-a7f5-1731f7af6d3b"),
                            AmputationName = "Hand Partial"
                        },
                        new
                        {
                            Id = new Guid("a349f95a-b6ef-4ff7-a5cf-d80c387199b8"),
                            AmputationName = "Wrist Disarticulation"
                        },
                        new
                        {
                            Id = new Guid("0644d72a-c893-4039-8460-d1179352573f"),
                            AmputationName = "Transradial"
                        },
                        new
                        {
                            Id = new Guid("318ce2d0-7263-4a00-a51f-9e35811f52e9"),
