...
namespace IW7PP.Migrations
{
    ...
    [Migration("20240610025524_ModificateColumnProtesisIdtoAllowNulls")]
    partial class ModificateColumnProtesisIdtoAllowNulls
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IW7PP.Models.Amputations.LowerLimbAmputation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d8193d9e-ba9d-45a5-8290-62ac0e041944"),
                            AmputationName = "Below Knee"
                        },
                        new
                        {
                            Id = new Guid("84ca52d6-5fd7-48bf-ba03-f461c61b8c13"),
                            AmputationName = "Above Knee"
                        },
                        new
                        {
                            Id = new Guid("537406fe-2005-4f65-8b9a-e7825ec70e80"),
                            AmputationName = "ToePartial"
                        },
                        new
                        {
                            Id = new Guid("52e38285-f63c-47f6-b819-1e9f0fa8708c"),
                            AmputationName = "ToeComplete"
                        },
                        new
                        {
                            Id = new Guid("7f91d381-9ccd-4239-9a24-4a8516e029fd"),
                            AmputationName = "FootPartial"
                        },
                        new
                        {
                            Id = new Guid("88e7688a-b1f0-487a-a2a5-1ec2a9995e16"),
                            AmputationName = "Lisfranc"
                        },
                        new
                        {
                            Id = new Guid("000bc71d-cc63-4e56-9ee7-3ff8c1d77dcb"),
                            AmputationName = "Chopart"
                        },
                        new
                        {
                            Id = new Guid("1ff1eeee-a5d0-41ed-8a52-d63126be5c7f"),
                            AmputationName = "AnkleDisarticulation"
                        },
                        new
                        {
                            Id = new Guid("fc31c64f-6faf-40cc-b83f-5fc634c2b754"),
                            AmputationName = "Transtibial"
                        },
                        new
                        {
                            Id = new Guid("9c272054-5023-4bf8-87d3-8195920f61e2"),
                            AmputationName = "KneeDisarticulation"
                        },
                        new
                        {
                            Id = new Guid("abfb034c-4dce-4420-9490-4cbf1f51f605"),
                            AmputationName = "Transfemoral"
                        },
                        new
                        {
                            Id = new Guid("11233488-278b-435b-bda0-ecba6451ff06"),
                            AmputationName = "HipDisarticulation"
                        },
                        new
                        {
                            Id = new Guid("9061113e-d73d-45c3-b139-bd05c4454ce0"),
            ...
            modelBuilder.Entity("IW7PP.Models.Amputations.UpperLimbAmputation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8be33d8b-8912-4a8d-baf9-d9758c4e1a42"),
                            AmputationName = "Finger Partial"
                        },
                        new
                        {
                            Id = new Guid("b5ed041c-5679-4530-9262-7a9da24ab5a1"),
                            AmputationName = "Finger Complete"
                        },
                        new
                        {
                            Id = new Guid("d4109c26-32ff-4d6f-a633-5f441f48bc0d"),
                            AmputationName = "Hand Partial"
                        },
                        new
                        {
                            Id = new Guid("bb1048e3-21f3-4158-a914-635047681347"),
                            AmputationName = "Wrist Disarticulation"
                        },
                        new
                        {
                            Id = new Guid("d8bb67ca-3bc1-4f4b-b484-3a140707992a"),
                            AmputationName = "Transradial"
                        },
                        new
                        {
                            Id = new Guid("9d45bbb7-f567-43fd-a0cb-557244a222f8"),
